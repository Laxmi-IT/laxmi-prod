      ...
      {authors && authors.length > 0 ? (
          ...
          {authors.map((author) => (
            ...
            >
              <div className="flex items-center gap-4 mb-4">
                ...
                <button className="p-2 text-zinc-400 hover:text-white hover:bg-zinc-700 rounded transition-colors flex-shrink-0">
        ...
        <div className="text-center py-12 bg-zinc-900 border border-zinc-800 rounded-lg">
          ...
          <p className="text-sm text-zinc-500 mb-6">
            Authors will appear here after running the database migrations and seed scripts.
          </p>
        </div>
      )}
    </div>
