...
const translations = {
  it: {
    ...
    description: "Arredamento di lusso su misura Made in Italy. Creiamo spazi che raccontano storie di eccellenza italiana.",
  ...
  en: {
    ...
    description: "Bespoke luxury furniture Made in Italy. We create spaces that tell stories of Italian excellence.",
